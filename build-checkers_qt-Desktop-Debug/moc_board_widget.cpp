/****************************************************************************
** Meta object code from reading C++ file 'board_widget.hh'
**
...
#include "../Qt/inc/board_widget.hh"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'board_widget.hh' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 17), // "timerEventHandler"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "BoardWidget\0timerEventHandler\0"
};
...
void BoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->timerEventHandler(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
